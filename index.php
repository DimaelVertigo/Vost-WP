...
get_header(); ?>
	...
	<div class="container container--dark clearfix">
		...
		<section class="jumbotron clearfix">
			...
			<div class="slider clearfix">
				...
				<a href="#" class="btn btn--jumbotron">Хочу VOST</a>
				<div class="plans_slider">
					<div class="slide">
						<span class="slide__item">Технология интерактивной рекламы на стеклянных поверхностях</span>
					</div>
					<div class="slide">
						<span class="slide__item">Сначала лампа</span>
					</div>
					<div class="slide">
						<span class="slide__item">Потом текст</span>
					</div>
					<div class="slide">
						<span class="slide__item">Технология интерактивной рекламы на стеклянных поверхностях</span>
					</div>
	...
	<div class="container container--light clearfix" id="ancor1">
		...
		<section class="content-block-1">
			<div class="wrapper">
				<h2 class="title title--content-block-1 title--dark">
